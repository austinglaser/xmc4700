...
impl core::convert::From<crate::R<CGATSTAT1_SPEC>> for R {
...
pub struct USIC2_R(crate::FieldReader<bool, USIC2_A>);
impl USIC2_R {
    pub(crate) fn new(bits: bool) -> Self {
        USIC2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for USIC2_R {
    type Target = crate::FieldReader<bool, USIC2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
