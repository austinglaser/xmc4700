...
impl core::convert::From<crate::R<CLKSTAT_SPEC>> for R {
...
pub struct EBUCST_R(crate::FieldReader<bool, EBUCST_A>);
impl EBUCST_R {
    pub(crate) fn new(bits: bool) -> Self {
        EBUCST_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for EBUCST_R {
    type Target = crate::FieldReader<bool, EBUCST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
