...
impl core::convert::From<crate::R<PRSTAT1_SPEC>> for R {
...
pub struct USIC2RS_R(crate::FieldReader<bool, USIC2RS_A>);
impl USIC2RS_R {
    pub(crate) fn new(bits: bool) -> Self {
        USIC2RS_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for USIC2RS_R {
    type Target = crate::FieldReader<bool, USIC2RS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
